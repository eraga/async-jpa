 ...
 * @since 2.2
 */
fun <T> TypedQuery<T>.rxResultStream(
        scheduler: Scheduler? = null
): Single<Stream<T>> = blockingSingle(scheduler) {
    this.resultStream
}
 ...
 * @since 2.2
 */
fun Query.rxResultStream(
        scheduler: Scheduler? = null
): Single<Stream<Any?>> = blockingSingle(scheduler) {
    this.resultStream
}
 ...
 * @since 2.2
 */
//fun Query.getResultStream(
//        scheduler: Scheduler? = null
//): Observable<Any?> = streamObservable(scheduler) {
//    this.resultStream
//}
